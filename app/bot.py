...
BOT_TOKEN    = os.environ.get("BOT_TOKEN",    "8643303857:AAHvpU6H7dtVhjsn3YbRZd2sO_QvvXnzc1E")
MINI_APP_URL = os.environ.get("MINI_APP_URL", "https://dropify-exe.vercel.app/u/watch-earn")
FB_DB_URL    = os.environ.get("FB_DB_URL",    "https://watch-and-earn-d5ac8-default-rtdb.firebaseio.com")
...
def send_referral(chat_id, tg_id):
    ...
    ref_link = f"https://t.me/Watch_and_earn_free_bot?start={ref_code}"
    tg("sendMessage", {
        "chat_id":    chat_id,
        "parse_mode": "Markdown",
        "text": (
...
def index():
    return jsonify({"status": "running", "bot": "@Watch_and_earn_free_bot"})
